...
class BaseAPIRequestLog(models.Model):
    ...
    username_persistent = models.CharField(max_length=getattr(settings, 'DRF_TRACKING_USERNAME_LENGTH', 200), null=True, blank=True)
    ...
    view = models.CharField(max_length=getattr(settings, 'DRF_TRACKING_VIEW_LENGTH', 200), null=True, blank=True, db_index=True, help_text='method called by this endpoint')
